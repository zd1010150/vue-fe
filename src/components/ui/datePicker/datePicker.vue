...
<div class="mu-date-picker" :class="{'fullWidth': fullWidth}">
    ...
    <div class="input-group input-group-icon">
      <text-field class="form-control" @focus="handleFocus" @labelClick="handleClick" :value="inputValue" :disabled="disabled" :fullWidth="fullWidth"
  ...
  <date-picker-dialog v-if="!disabled" @monthChange="handleMonthChange" @yearChange="handleYearChange" @accept="handleAccept"
  @dismiss="dismiss" :initialDate="dialogDate" ref="dialog" :mode="mode" :maxDate="maxLimitDate" :minDate="minLimitDate" :shouldDisableDate="shouldDisableDate" :firstDayOfWeek="firstDayOfWeek" :container="container" :disableYearSelection="disableYearSelection" :dateTimeFormat="dateTimeFormat" :autoOk="autoOk" :okLabel="okLabel" :cancelLabel="cancelLabel"/>
</div>
</template>
<script>
import * as dateUtils from 'muse-ui/src/datePicker/dateUtils'
import textField from 'muse-ui/src/textField'
import datePickerDialog from 'muse-ui/src/datePicker/datePickerDialog'
export default {
  props: {
    dateTimeFormat: {
      type: Object,
