<template>
  <div class="toggle-language">
    ...
    <mu-popover popoverClass="language-list-wrapper" :trigger="trigger" ref="languagePopover" :open="open"
                @close="handleClose" :anchorOrigin='{"vertical":"top","horizontal":"middle"}'
