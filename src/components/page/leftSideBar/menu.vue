<template>
  <div><button @click="openNestedMenuTest">openNestedMenu</button>
  <mu-list class="leftsidebar-menu-list" activeClass="active-router" @itemClick="menuItemClick">
    ...
    <mu-list-item title="Fund Management" toggleNested nestedListClass="level2-menu" :open="isItemOpen[1]" @click="itemClick(1)">
    ...
    <mu-list-item title="Agent Center" toggleNested nestedListClass="level2-menu" key="2" :open="isItemOpen[2]" @click="itemClick(2)" >
    ...
    <mu-list-item title="Ticket" toggleNested nestedListClass="level2-menu" key="3" :open="isItemOpen[3]" @click="itemClick(3)">
    ...
    <mu-list-item title="Training" toggleNested nestedListClass="level2-menu" key="4" :open="isItemOpen[4]" @click="itemClick(4)" >
      <mu-icon slot="left" value="school" />
      <mu-list-item title="Online Training" slot="nested"></mu-list-item>
      <mu-list-item title="Books and Magazines" slot="nested" toggleNested nestedListClass="level3-menu" key=5 :open="isItemOpen[5]" @click="itemClick(5)"  >
        <mu-list-item title="Money Theory" slot="nested"></mu-list-item>
        <mu-list-item title="Education Books" slot="nested"></mu-list-item>
      </mu-list-item>
      <mu-list-item title="Videos" slot="nested" toggleNested nestedListClass="level3-menu" key=6 :open="isItemOpen[6]" @click="itemClick(6)"  >
