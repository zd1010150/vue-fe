        ...
        <chp-panel :canCollapse="false" :canClose="false" :isLoading="loadingStatus">
          ...
          <form slot="body" class="form-horizontal form-bordered " ref="accountForm">
            <div class="form-group" :class="errorClass('platForm')">
              ...
              <div class="col-md-6">
                <mu-select-field v-model="model.plat_form" v-validate="'required'" data-vv-value-path="model.plat_form"
                                 name="platForm">
                ...
                <span slot="required" class="error"
                      v-if="errors.has('platForm:required')">{{errors.first('platForm:required')}}</span>
              </div>
            </div>
            <div class="form-group" :class="errorClass('accountType')">
              ...
              <div class="col-md-6">
                <mu-select-field v-model="model.account_type" v-validate="'required'"
                                 data-vv-value-path="model.account_type" name="accountType">
                ...
                <span slot="required" class="error"
                      v-if="errors.has('accountType:required')">{{errors.first('accountType:required')}}</span>
              </div>
            </div>
            <div class="form-group" :class="errorClass('lever')">
              ...
              <div class="col-md-6">
                <mu-select-field v-model="model.lever" v-validate="'required'" data-vv-value-path="model.lever"
                                 name="lever">
            ...
            <div class="form-group" :class="errorClass('baseCurrency')">
              ...
              <div class="col-md-6">
                <mu-select-field v-model="model.base_currency" v-validate="'required'"
                                 data-vv-value-path="model.base_currency" name="baseCurrency">
                ...
                <span slot="required" class="error"
                      v-if="errors.has('baseCurrency:required')">{{errors.first('baseCurrency:required')}}</span>
              </div>
            </div>
            <div class="form-group" :class="errorClass('reason')">
              ...
              <div class="col-md-6">
                ...
                <span slot="required" class="error"
                      v-if="errors.has('reason:required')">{{errors.first('reason:required')}}</span>
              </div>
            </div>
            <div class="form-group" :class="errorClass('terms')">
              <div class="col-md-9 col-md-offset-3">
                <chp-checkbox name="terms" nativeValue="checkedIterms" v-model="checkedIterms"
                              data-vv-value-path="checkedIterms" v-validate="'required'" data-vv-name="terms"
                              type="checkbox">
                  <a class="" href="https://www.acy.com/why-acy/terms-and-conditions"
                     target="_blank">{{ $t('applicationSubaccount.agreenTerms')}}</a>
                </chp-checkbox>
                <br>
