	...
	<div class="col-md-12 col-sm-12 filter pt-sm pr-none pl-none">
        <form class="form-inline">
            <div class="form-group" :class="errorClass('startDate')">
              <chp-date-picker class="date start-date" 
				              :hintText="$t('ui.datePicker.startDate')" 
                ...
                <span  class="error" v-if="errors.has('startDate:required')">
              		{{errors.first('startDate:required')}}
                </span>
            </div>
            <div class="form-group " :class="errorClass('endDate')">
              <chp-date-picker class="date end-date" 
				              :hintText="$t('ui.datePicker.endDate')" 
				              @input="changeEndday" 
				              :minDate = "minEndDate" 
				              ...
				              :required="true" 
				              data-vv-validate-on="change"/>
                <span class="error" v-if="errors.has('endDate:required')">
