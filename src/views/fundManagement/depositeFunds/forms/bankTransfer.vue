  ...
  <chp-panel :canCollapse="false" :canClose="false" :isLoading="loadingStatus">
    ...
    <template slot="body">
      ...
      <div class="row padding-20" v-if="allInfos">
        <div v-for="(infos,index) in allInfos" class="col-lg-6 col-md-6 col-sm-12 bank-detail mb-lg padding-10"
             id="bank-detail" :id="index+'print'">
          <h5> {{ $t('deposit.acyAccountDetail')}}
            <small>({{ currencies.join("、")}})</small>
          </h5>
          <table>
            <tr>
            ...
            <tr>
              ...
              <td class="print-btn-td ">
                <chp-button class="mb-xs mt-xs mr-xs btn btn-default print-btn hidden-md hidden-sm hidden-xs"
                            @click="print(index+'print')">
            ...
            <tr class="visible-md visible-sm visible-xs ">
              <td colspan="3" class="padding-10">
                <chp-button class="mb-xs mt-xs mr-xs btn btn-default print-btn pull-right"
                            @click="print(index+'print')">
                  <i class="fa fa-print"></i> {{ $t('ui.button.print') }}
                </chp-button>
              </td>
