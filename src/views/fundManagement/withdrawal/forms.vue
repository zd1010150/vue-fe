      ...
      <chp-tabs :value="activeStepTab" @change="handleStepTabChange" type="wizard" slot="body">
        ...
        <template slot="content">
          <chp-expand-transition name="chp-fade">
            <keep-alive>
              <component :is="currentView" @loading="loadingData" @submit="submitData" @disableSubmit="disableSubmit"
                         ref="tab"></component>
            </keep-alive>
      ...
      <div class="row" slot="footer">
        ...
        <div class="col-md-6 col-sm-6 col-xs-6">
          ...
          <chp-button class="mb-xs mt-xs mr-xs btn btn-primary print-btn pull-right" @click="submit"
                      v-if="activeStepTab =='tab3'" :disabled="hasSubmit">
            {{ $t('ui.button.submit') }}
    ...
    methods: {
      ...
      async submit () {
        ...
        if (result && this.model) {
          ...
          let {success} = await fundsService.withdrawal(this.model)
