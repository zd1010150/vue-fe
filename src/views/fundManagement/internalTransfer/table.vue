    ...
    <chp-panel :canCollapse="false" :canClose="false" :isLoading="loadingStatus">
      ...
      <chp-data-table slot="body"
        ...
        <chp-table slot="table" chp-sort="calories" chp-sort-type="desc" @sort="sortRow">
          <chp-table-header>
            <chp-table-row>
              <chp-table-head chp-sort-by="created_at" class="created_at">{{ $t('internalTransfer.time') }}
              </chp-table-head>
              <chp-table-head chp-sort-by="origin_login" width="100px">{{ $t('internalTransfer.fromAccount') }}
              </chp-table-head>
              <chp-table-head chp-sort-by="target_login" width="100px">{{ $t('internalTransfer.toAccount') }}
              </chp-table-head>
