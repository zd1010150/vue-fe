...
export default{
  ...
  async addBankCard({province,city,address,account,swift,bank_name,method,document,document_2}){
  	return fetchData('POST',"/bank-card",{province,city,address,account,swift,bank_name,method,document,document_2})
  },
  ...
  async updateBankCard(id,{province,city,address,account,swift,bank_name,method,document,document_2}){
  	return fetchData('PUT',"/bank-card/"+id,{province,city,address,account,swift,bank_name,method,document,document_2})
  }
}
